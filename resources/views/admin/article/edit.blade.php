...
<div class="row">
    <div class="col-md-12">
        @if(Session::has('message'))
            ...
            {{Session::get('message')}}, <a href="{{action('NewsController@show',['articles'=>$article->id])}}">открыть страницу</a>
            </p>
...
<div class="row">
        <form method="POST" action="{{action('Admin\ArticlesController@update',['articles'=>$article->id])}}"  enctype="multipart/form-data">
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-9">
                    <div class="row">
            ...
            <div class="row">
                <div class="col-md-12">
                    <p class="form-label">description:</p>
                        <input class="form-control" type="text" name="meta_description" value="{{$article->meta_description}}">
                    </p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    ...
                    <input class="form-control"  type="text" name="meta_keywords" value="{{$article->meta_keywords}}">
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
